...
\makebox[\textwidth]{\includegraphics[width=8cm]{figures/ProjectHierarchy.png}}
...
\newline
\makebox[\textwidth]{\includegraphics[width=8cm]{figures/FlowChart.png}}
...
\makebox[\textwidth]{\includegraphics[width=8cm]{figures/SpiralDevelopment.png}}
...
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{figures/LogicalModel.png}}
\end{center}
\subsection{Relational Model}
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=\textwidth]{figures/RelationalModel.png}}
\end{center}
\subsection{Java GUI Design}
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=12cm]{figures/gui1.png}}
\end{center}
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=12cm]{figures/gui2a.png}}
\end{center}
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=12cm]{figures/gui2b.png}}
\end{center}
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=12cm]{figures/gui2c.png}}
\end{center}
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=12cm]{figures/gui3a.png}}
\end{center}
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=12cm]{figures/gui3b.png}}
\end{center}
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=12cm]{figures/gui4a.png}}
\end{center}
\begin{center}
  \makebox[\textwidth]{\includegraphics[width=12cm]{figures/gui4b.png}}
\end{center}
